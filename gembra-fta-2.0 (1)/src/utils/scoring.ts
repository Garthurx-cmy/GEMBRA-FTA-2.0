...
export const SCORING_RULES: ScoringRule[] = [
  ...
  { key: "DIAL_COMPORTAMENTAL", label: "DIAL / Desvio Comportamental", points: 2 },
...
export function getSingleInspectionScore(insp: Inspection): number {
  ...
  if (
    launchType === "DIAL / Desvio Comportamental" ||
    act.includes("dial") ||
    tp.includes("dial") ||
    act.includes("desvio comportamental") ||
    tp.includes("desvio comportamental")
  ) {
    return 2;
  }
